...
class FormElementsContainer
{
    ...
    /**
     * Модель (для использования изображений)
     *
     * @var string $model
     */
    public ?string $model = null;

    public function __construct(string $key, string $name, ?callable $visible, array $elements, ?string $groupName = null, int $sort = 0, ?string $model = null)
    {
        $this->key = $key;
        $this->name = $name;
