<template>
    <div class="feedback-popup__heading">
        <h2>Рассчитайте стоимость наших услуг прямо сейчас!</h2>
        <p>Заполните форму и получите расчет стоимости.Мы свяжемся с вами, ответим на вопросы и поможем понять, какой формат бухгалтерского сопровождения подойдет вашей компании.</p>
    </div>
    <div class="feedback-popup__content">
        ...
        <form v-else @submit.prevent="store">
           <div class="feedback-popup__items">
               ...
               <div class="feedback-popup__item">
                   <TextField name="text" label="Комментарий" placeholder="Комментарий" v-model="form.text" :errors="errors['text']"/>
               </div>
...
export default {
    ...
    components: {TextField, InputField, PhoneField, CheckboxUi},
